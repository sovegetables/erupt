...
@Entity
@Table(name = "mes_allocation_record_detail")
@Getter
@Setter
@Erupt(name = "调拨单详情")
public class MesAllocationRecordDetail extends BaseModel {
    ...
    @EruptField(
            views = @View(title = "调拨数量"),
            edit = @Edit(title = "调拨数量", notNull = true, numberType = @NumberType(min = 0))
    )
