...
@Getter
@Entity
@Table(name = "mes_sale_return_record_detail")
@Erupt(name = "销售退货单详情")
public class MesSaleReturnRecordDetail extends BaseModel {
    ...
    @EruptField(
            views = @View(title = "退货量"),
            edit = @Edit(title = "退货量", notNull = true, numberType = @NumberType(min = 0))
    )
